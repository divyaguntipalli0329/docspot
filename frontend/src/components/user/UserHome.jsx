...
const UserHome = () => {
   ...
   const [activeMenuItem, setActiveMenuItem] = useState('bookAppointment'); // Default to Book Appointment
         ...
         <div className='main'>
            <div className="layout">
               <div className="sidebar">
                  ...
                  <div className="menu">
                     {/* Only show Book Appointment if NOT a doctor */}
                     {userdata.isdoctor !== true && (
                        <div className={`menu-items ${activeMenuItem === 'bookAppointment' ? 'active' : ''}`} onClick={() => handleMenuItemClick('bookAppointment')}>
                           <CalendarMonthIcon className='icon' /><Link>Book Appointment</Link>
                        </div>
                     )}
               ...
               <div className="content">
                  ...
                  <div className="body">
                     {/* Only show Book Appointment if NOT a doctor */}
                     {activeMenuItem === 'bookAppointment' && userdata.isdoctor !== true && (
                        <Container>
                           ...
                           <Row>
                              {doctors && doctors.length > 0 ? doctors.map((doctor, i) => {
                                 ...
                                 <div className="text-center w-100">No doctors available.</div>
                              )}
                           </Row>
                        </Container>
                     )}
